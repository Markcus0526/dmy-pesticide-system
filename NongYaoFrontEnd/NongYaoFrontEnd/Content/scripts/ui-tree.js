    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource5 = new DataSourceTree({
                data: [
                    { name: '货品类别<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    { name: '除草剂<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                ],
                delay: 400
            });  
			...
			$('#chemicalTypeTree').tree({
				selectable: false,
                dataSource: treeDataSource5,
                loadingHTML: '<img src="assets/img/input-spinner.gif"/>',
			});
			$('#chemicalTypeTree1').tree({
				selectable: false,
                dataSource: treeDataSource2,
                loadingHTML: '<img src="assets/img/input-spinner.gif"/>',
			});
