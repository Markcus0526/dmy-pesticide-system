(function ($, undefined) {
    ...
    var ABOVE = "above",
        ...
        INITIAL_ANIMATION_DURATION = 5000,
    ...
    var Chart = Component.extend(/** @lends kendo.ui.Chart.prototype */{
        ...
        _getPoint: function(e) {
			...
			if(model != undefined)
			{
				if(model.idMap != undefined)
				{
					var chartElement = model.idMap[targetId];
				}
				if(model.idMapMetadata != undefined)
				{
					var metadata = model.idMapMetadata[targetId];
				}
			}
            if (chartElement) {
