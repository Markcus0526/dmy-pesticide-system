...
namespace NongYaoBackend.Models.Library
{
    ...
    {
        public static string get39code(string s)
        {
        ...
        public static string get39image(string s, string result_bin, int width, int height)
        {
            Hashtable ht = new Hashtable();
            ...
            result_html += "<div style=\"width:" + (width * (len + 1)) + "px;float:left;color:#000000;text-align:center;\">&nbsp;</div>";
            foreach (char c in s)
            {
